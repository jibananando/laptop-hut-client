...
const AllBuyer = () => {
    ...
    const getData = () => {
        fetch(`https://laptop-hut-server-tawny.vercel.app/allSellersAndBuyers?role=buyer`)
            .then(res => res.json())
        ...
        fetch(`https://laptop-hut-server-tawny.vercel.app/deleteSellerAndBuyer/${id}`, {
            ...
            .then(data => {
                ...
                if (data?.message) {
                    ...
                    getData();
                    toast('Deleted Buyer successfully');
                }
            });
    }
    return (
        <div>
            <h1 className="text-3xl font-bold my-8"><span className='text-orange-600'>All</span> Buyer</h1>
